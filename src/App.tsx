    ...
    <div className="flex min-h-screen bg-white dark:bg-gray-950 text-gray-800 dark:text-gray-200 transition-colors">
      ...
      <div className={`fixed top-14 left-0 w-56 h-[calc(100vh-3.5rem)] bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 z-50 flex flex-col justify-between py-6 px-4 transition-transform duration-300 md:hidden ${menuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-[#1DA1F2] hover:opacity-70 transition-opacity">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl p-6 flex items-center gap-4 hover:border-indigo-300 dark:hover:border-indigo-700 transition-colors">
                ...
                <div>
                  ...
                  <a href="https://github.com/toufeeqkalam" target="_blank" rel="noopener noreferrer" className="text-sm font-mono text-gray-700 dark:text-gray-300 hover:text-indigo-500 transition-colors">github.com/toufeeqkalam</a>
                </div>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl p-6 flex items-center gap-4 hover:border-indigo-300 dark:hover:border-indigo-700 transition-colors">
                ...
                <div>
                  ...
                  <a href="https://www.linkedin.com/in/toufeeqkalam" target="_blank" rel="noopener noreferrer" className="text-sm font-mono text-gray-700 dark:text-gray-300 hover:text-indigo-500 transition-colors">linkedin.com/in/toufeeqkalam</a>
                </div>
              </div>
